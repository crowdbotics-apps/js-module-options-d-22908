...
## Project Structure
    ...
    ├── js_module_options_d_22908  # Django project configurations
...
1. Clone this repo and `cd js_module_options_d_22908`
...
2. Clone this repo and `cd js_module_options_d_22908`
